...
* `UniformGridMapping.__call__(origin_x, origin_y, dest_x, dest_y)` floors coordinates into half-open `[k, k+1) · type_width` buckets and emits `((o_ix, o_iy), (d_ix, d_iy))` indices.【F:src/ddp/mappings/uniform_grid.py†L36-L95】
